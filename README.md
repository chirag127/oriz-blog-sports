# Sports — `oriz-blog-sports`

> The game, broken down — analysis, training, and the numbers behind the play.

[![License: MIT](https://img.shields.io/badge/License-MIT-e4572e.svg)](./LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/chirag127/oriz-blog-sports?style=flat)](https://github.com/chirag127/oriz-blog-sports/stargazers)
[![Last commit](https://img.shields.io/github/last-commit/chirag127/oriz-blog-sports)](https://github.com/chirag127/oriz-blog-sports/commits/main)
[![Deploy](https://github.com/chirag127/oriz-blog-sports/actions/workflows/deploy.yml/badge.svg)](https://github.com/chirag127/oriz-blog-sports/actions/workflows/deploy.yml)
[![Built with Astro](https://img.shields.io/badge/built%20with-Astro-ff5d01.svg)](https://astro.build)

**Sports** is a static, content-first blog built with Astro and deployed to Cloudflare Pages.
A sports blog covering analysis, training, and the data behind the games — for fans who want more than the highlight reel.

- **Live site:** https://sports-blog.oriz.in · **Repo:** https://github.com/chirag127/oriz-blog-sports
- **GitHub Pages landing:** https://chirag127.github.io/oriz-blog-sports/ — the canonical, always-current site is **https://sports-blog.oriz.in** (Cloudflare Pages); GitHub Pages is not the deploy target for this repo.

> ⭐ **If this is useful, please [star the repo](https://github.com/chirag127/oriz-blog-sports/stargazers)** — it helps others find it.
...
flowchart LR
    ...
    D --> E["Cloudflare Pages<br/>sports-blog.oriz.in"]
...
oriz-blog-sports/
├── src/
│   ├── content/blog/       # the sports analysis (MDX/Markdown)
